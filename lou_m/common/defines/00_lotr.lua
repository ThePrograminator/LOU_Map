...
NDefines.NCountry.COHESION_FEDERATION_MEMBER_WRONG_CULTURE = 0.10
NDefines.NCountry.COHESION_FEDERATION_MEMBER_CORRECT_CULTURE = 0.20
NDefines.NCountry.COHESION_FEDERATION_ADVANCEMENT = -0.02
